                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                Nova.request().get('/nova-vendor/davidpiesse/nova-phpinfo/phpinfo').then(function (response) {
...
var render = function() {
  ...
  return _c("div", [
    _vm.loaded
      ? _c(
          "div",
          _vm._l(_vm.data, function(contents, title) {
            return _c(
              "card",
              { key: title, staticClass: "flex flex-col mb-6 p-4" },
              [
                _c("h2", {
                ...
                _c(
                  ...
                  _vm._l(contents, function(item, index) {
                    return _c(
                      "div",
                      { key: index, staticClass: "w-full mb-3 flex" },
                      [
                        ...
                        _vm._v(" "),
                        _c("div", { staticClass: "w-3/4 px-2 font-thin" }, [
                          Array.isArray(item)
                            ? _c(
                                "div",
                                {
                                ...
                                _vm._l(item, function(arrayitem, index) {
                                  return _c("div", {
                                    key: index,
                                    class: "w-1/" + item.length,
                                    domProps: { innerHTML: _vm._s(arrayitem) }
                                  })
                                })
                              )
                            : item == "enabled" || item == "Yes"
                              ? _c("div", [
                                  _c(
                                    "svg",
                                    {
                                      staticClass:
                                        "w-4 h-4 text-success fill-current",
                                      attrs: {
                              ...
                              : item == "disabled" || item == "No"
                                ? _c("div", [
                                    _c(
                                      "svg",
                                      {
                                        staticClass:
                                          "w-4 h-4 text-danger fill-current",
                                        attrs: {
                                          xmlns: "http://www.w3.org/2000/svg",
                                          viewBox: "0 0 512 512"
                                        }
